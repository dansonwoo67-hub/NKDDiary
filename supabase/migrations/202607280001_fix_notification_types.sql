-- Fix notification types for profile changes and calendar events

-- Update notify_partner_profile_change to use specific types
...
-- Create function for creating calendar event notifications
