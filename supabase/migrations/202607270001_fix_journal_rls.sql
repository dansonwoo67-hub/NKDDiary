-- Fix RLS policy for journal entries to allow recipients to read letters before opening
-- This addresses the issue where inbox shows 0 letters but notifications exist
-- because the old policy required opened_at is not null for recipients
...
-- Ensure mood_emoji and star_at columns exist (from migration 202607260010)
