-- Add metadata and related_entry_id columns to notifications table
alter table public.notifications add column if not exists metadata jsonb;
alter table public.notifications add column if not exists related_entry_id uuid;

-- Update notify_partner_profile_change to save nickname_snapshot in metadata
...
-- Update create_calendar_event_notification to save structured metadata
